...
var crown = new PIXI.Sprite.fromImage('images/crown.png');
var player1logo = new PIXI.Sprite.fromImage('images/p1.png');
var player2logo = new PIXI.Sprite.fromImage('images/p2.png');
var sprite1 = new PIXI.Sprite.fromImage('images/p1.png');
var sprite2 = new PIXI.Sprite.fromImage('images/p2.png');
var checker = new PIXI.Sprite.fromImage('images/checker.png');
...
function update2() {
  ...
  if (!running && started) {
    ...
    checkPlacing();
    if (values[n1 - 1]) pVal1 = values[n1 - 1];else {
      pVal1 = values[n1];
    }
    running1 = false;
  }
